...
class FileUploadRequest(BaseModel):
    ...
    file_size: int = Field(..., description="The type of the file")
    file_type :str  = Field(..., description="The size of the file")

#Enums, short for enumerations, are a way to represent a set of named constant values in Python
class ProcessingStatus(str, Enum): # Enum defines constants, add str and enum understands that the values are string
    UPLOADING = "uploading"
    PENDING = "pending"
    QUEUED = "queued"
