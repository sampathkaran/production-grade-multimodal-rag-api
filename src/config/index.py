# common configuration file setup 
...
if not os.getenv('SUPABASE_API_URL') or not os.getenv("SUPABASE_SERVICE_KEY"):
    raise ValueError(
        "SUPABASE_API_URL and SUPABASE_SERVICE_KEY must be set in the .env file."
    )
...
# defining all env variables a a dict 

app_config = {
    "supabase_api_url": os.getenv("SUPABASE_API_URL"),
    # "supabase_secret_key": os.getenv("SUPABASE_SECRET_KEY"),
    "supabase_sevice_key": os.getenv("SUPABASE_SERVICE_KEY"),
