...
- Support for both Tavily search engine
...
- If rag_search returns no relevant results AND the query is about 
  current events, news, or external information, you MUST then call 
  search_web. Do NOT respond to the user until you have tried both tools
